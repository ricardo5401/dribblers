...
class AppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post applies_url, params: { apply: { active: @apply.active, model: @apply.model, model_id: @apply.model_id, user_id: @apply.user_id } }
    end
  ...
  test "should update apply" do
    patch apply_url(@apply), params: { apply: { active: @apply.active, model: @apply.model, model_id: @apply.model_id, user_id: @apply.user_id } }
